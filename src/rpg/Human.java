...
public class Human {
	...
	//アイテム使用
	public void herb(Human target){
		target.setVitality(target.getVitality() + 10);	//たいりょくを10回復
		System.out.println("10回復した" );
	}
	...
	public void specialEvilAttack(Human target){ //共通のメソッドとして使うためオーバーライド

	}

	public void specialAttack(Human target){ //共通のメソッドとして使うためオーバーライド
